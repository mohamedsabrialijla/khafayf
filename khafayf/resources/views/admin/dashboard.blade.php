...
@section('title'){{"KHafayf"}}@endsection
@section('page-style')@endsection
@section('content-header')
    <h1>KHafayf Application</h1>
    <ol class="breadcrumb">
...
@section('js-plugins')
    ...
    <!-- ChartJS 1.0.1 -->
    <script src="{{url('/admin_assets/plugins/chartjs/Chart.min.js')}}"></script>
    <!-- AdminLTE dashboard demo (This is only for demo purposes) -->
    <script src="{{url('/admin_assets/dist/js/pages/dashboard2.js')}}"></script>
@endsection
